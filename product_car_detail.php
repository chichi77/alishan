...
<meta property="og:url" content="http://demo.dake.com.tw/~liao/alishan/product_car_detail.php"></meta>
<meta property="og:image" content="http://demo.dake.com.tw/~liao/alishan/images/car_02.jpg"></meta>
...
$(function(){
	...
	$('#postForm').submit(function(event) {
		if(!check_input_date($(this))){
			...
			alert('請選擇車型');
			console.log(Date($(this).find('input[type="date"]').eq(0).prop('max').replace(/-/g,'/')))
			return false;
		}
	});
		...
		<div class="max_width">
			<div class="product_item">
				<ul class="breadcrumb">
					...
					<li>
						<a href="product_car.php">嘉義縣</a>
					</li>
					<li>
						<a href="product_car.php">嘉義</a>
					</li>
				</ul>
					...
					<div class="product_cart">
						<form name="postForm" id="postForm" action="cart_1.php">
							<div class="cart_item">
								...
								<input type="date" name="date" class="required" value="<?php echo date('Y-m-d'); ?>" min="<?php echo date('Y-m-d'); ?>">
