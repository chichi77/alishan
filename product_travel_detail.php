...
$(function(){
    ...
    $('.product_cart .menu_first>li').eq(0).addClass('active');
    $('.product_cart .menu_second>li').eq(0).addClass('active');
    $('.product_item_detail_menu>li').eq(0).addClass('active');
    $('.product_item_detail>div').eq(0).addClass('active');

    $('.product_cart .menu_first li').click(function(event) {
    	let click_num = $('.product_cart .menu_first>li').index(this);

    	$('.product_cart .menu_first>li').removeClass('active');
    	$('.product_cart .menu_second>li').removeClass('active');
    	$(this).addClass('active');
    	$('.product_cart .menu_second>li').eq(click_num).addClass('active');
    });
...
<div class="product_page detail travel_detail">
				...
				<div class="product_item_inner">
					...
					<div class="product_cart">
						<form class="cart_item" id="postForm" name="postForm" action="cart_1.php">
							...
							<input name="type" type="num" value="1" style="display: none;">
							...
							<ul class="menu_second">
								<li>
									<ul class="menu_third">
										...
										<li>
											<div>單人房 </div>
											<div><span>$4800</span>/人 </div>
										</li>
										<li>
											<div>雙人房 </div>
											<div><span>$5800</span>/人 </div>
										</li>
										<li>
											<div>四人房 </div>
											<div><span>$6600</span>/人 </div>
										</li>
										<li>
											<div>六人房 </div>
											<div><span>$7800</span>/人 </div>
										</li>
									</ul>
								</li>
								<li>
									<ul class="menu_third">
										...
										<li>
											<div>雙人房 </div>
											<div><span>$6800</span>/人 </div>
										</li>
										<li>
											<div>四人房 </div>
											<div><span>$7600</span>/人 </div>
										</li>
										<li>
											<div>六人房 </div>
											<div><span>$8800</span>/人 </div>
										</li>
									</ul>
								</li>
								<li>
									<ul class="menu_third">
										...
										<li>
											<div>單人房 </div>
											<div><span>$5300</span>/人 </div>
										</li>
										<li>
											<div>雙人房 </div>
											<div><span>$6300</span>/人 </div>
										</li>
										<li>
											<div>四人房 </div>
											<div><span>$7100</span>/人 </div>
										</li>
										<li>
											<div>六人房 </div>
											<div><span>$8300</span>/人 </div>
										</li>
									</ul>
								</li>
								<li>
									<ul class="menu_third">
										...
										<li>
											<div>雙人房 </div>
											<div><span>$7300</span>/人 </div>
										</li>
										<li>
											<div>四人房 </div>
											<div><span>$8100</span>/人 </div>
										</li>
										<li>
											<div>六人房 </div>
											<div><span>$9300</span>/人 </div>
										</li>
									</ul>
								</li>
							</ul>
							<div class="price_info">
								<span>0~2歲幼兒(不佔床位、不佔車位、不含餐)   $800/人</span>
								<span>3~6歲兒童(不佔床位、佔車位、含餐)   $2200/人</span>
							</div>
							<div class="form_btn">
								<form name="postForm2">
