...
<div class="about_page">
	...
	<div class="max_width page_inner">
		<div class="edit_style">
			...
			<p>非常歡迎您光臨「愛玩美旅遊網」（以下簡稱本網站），為了讓您能夠安心使用本網站的各項服務與資訊，特此向您說明本網站的隱私權保護政策，以保障您的權益，請您詳閱下列內容：</p>
			<br>
			<h4><b>一、隱私權保護政策的適用範圍</b></h4>
			<p>隱私權保護政策內容，包括本網站如何處理在您使用網站服務時收集到的個人識別資料。隱私權保護政策不適用於本網站以外的相關連結網站，也不適用於非本網站所委託或參與管理的人員。</p>
			<br>
			<h4><b>二、個人資料的蒐集、處理及利用方式</b></h4>
			...
			<br>
			<h4><b>四、網站對外的相關連結</b></h4>
			<p>本網站的網頁提供其他網站的網路連結，您也可經由本網站所提供的連結，點選進入其他網站。但該連結網站不適用本網站的隱私權保護政策，您必須參考該連結網站中的隱私權保護政策。</p>
			<br>
			<h4><b>五、與第三人共用個人資料之政策</b></h4>
			...
			<p>前項但書之情形包括不限於：<br>
				<ul>
					...
					與公務機關或學術研究機構合作，基於公共利益為統計或學術研究而有必要，且資料經過提供者處理或蒐集著依其揭露方式無從識別特定之當事人。</li>
